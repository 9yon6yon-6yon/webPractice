# Generated by Django 4.2.2 on 2023-08-19 16:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('A', 'Language'), ('B', 'General Education'), ('C', 'Basic Sciences'), ('D', 'Mathematics'), ('E', 'Other Engineering'), ('F', 'Core Courses'), ('G', 'Elective Courses'), ('H', 'University required courses'), ('I', 'Final Year Design Project')], max_length=1)),
        ...
        migrations.AddField(
            model_name='course',
            name='faculty',
            field=models.ManyToManyField(blank=True, related_name='courses_assigned', to='Lms.users'),
        ),
        migrations.AddField(
            model_name='course',
            name='resources',
